...
<head>
    ...
    <title>Bank | Block Card</title>
    <meta name="description" content="Block your credit card" />
        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Block Card</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                            <section class="hk-sec-wrapper">
                                    <h5 class="hk-sec-title">Block Card</h5>
                                    <p class="mb-25">Enter the correct name on your card followed by your pin to block </p>
                                    <div class="row">
                                            <div class="col-sm">
                                                <form method="post" action="block-card.php">
                                                    <div class="form-row align-items-center">
                                                        <div class="col-auto form-group">
                                                            <label for="Cardholder">Bank name</label>
                                                            <input type="text" class="form-control mb-2" placeholder="Bank name" required>
                                                        </div>
                                                        <div class="col-auto form-group">
                                                        ...
                                                        <div class="col-auto form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="password" class="form-control  mb-2"
                                                                     placeholder="Pin" maxlength="4" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-auto form-group">
                                                        <label for=""> </label>
