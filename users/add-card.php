...
$ro = mysqli_fetch_array($results, MYSQLI_BOTH);
    ...
    <meta charset="UTF-8" />
        ...
        <title>Bank | Add Card</title>
        <meta name="description" content="Add credit card" />
            ...
            <div class="hk-pg-wrapper">
                ...
                <div class="container">
                    ...
                    <section class="hk-sec-wrapper">
                        <h5 class="hk-sec-title">Add Card</h5>
                        <p class="mb-25">Fill in all the fields below to add card.</p>
                        <div class="row">
                            <div class="col-sm">
                                <form method="post" action="add-card.php">
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input name="card_holder_name" class="form-control" placeholder="" type="text" required>
                                            <small class="form-text text-muted">Full name as displayed on card</small>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Card number</label>
                                            <input name="card_number" class="form-control" placeholder="" maxlength="16" type="text" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            <label>Expiration</label>
                                            <input name="expiry_date" class="form-control" placeholder="" data-mask="99/99" type="text" required>
                                        ...
                                        <div class="col-md-3 form-group">
                                            <label for="">CVV</label>
                                            <input name="cvv" class="form-control" maxlength="3" placeholder="" type="password" required>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Pin</label>
                                            <input name="pin" class="form-control" placeholder="" maxlength="4" type="password" required>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="">Bank name</label>
                                            <input name="bank_name" class="form-control" placeholder="" type="text" required>
                                        </div>
                                    </div>
                    ...
                    if (isset($_POST['add'])) {
                        ...
                        $cvv = $_POST['cvv'];
                        $pin = $_POST['pin'];
                        $credit_card = "INSERT INTO credits (card_holder_name, bank_name, card_number, expiry_date, ccv, pin, date)
 VALUES('$card_holder_name', '$bank_name', '$card_number', '($expiry_date)', '$cvv', '$pin',  now())";
                        $ans = mysqli_query($myConn, $credit_card);
