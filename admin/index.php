...
<head>
    ...
    <link href="plugins/advanced-datatable/css/demo_page.css" rel="stylesheet"> </head>
                                        ...
                                        <div class="block-web">
                                            ...
                                            <div class="porlets-content">
                                                <form action="config_user.php" method="post" class="form-horizontal row-border" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Previous Balance</label>
                                                        <div class="col-sm-9">
                                                            <input type="number" name="previous_balance" class="form-control" value="" required >
                                                        </div>
                                                    </div><!--/form-group-->
                                                ...
                                                <div class="porlets-content">
                                                    <form action="config_user.php" method="post"  class="form-horizontal row-border">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">Previous Balance </label>
                                                            <div class="col-sm-9">
                                                                <input type="text" name="previous_balance" class="form-control" value="<?php echo $previous_balance; ?>" required  >
                                                            </div>
                                                        </div><!--/form-group-->
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">Account Status</label>
